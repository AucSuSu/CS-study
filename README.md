...
|------|--------|---|---|---|---|---|---|
|2023.02.26|운영체제|캐시의 지역성|[CPU 스케줄링 / 스케줄러](https://github.com/AucSuSu/CS-study/blob/main/OS/os_cpuScheduling.md)|Context switching|메모리 단편화 / 가상 메모리 / 메모리 관리 전략|세마포어/뮤텍스|멀티스레드/데드락|
|2023.03.04|운영체제|캐시의 지역성|동기/비동기 차이|PCB / Interrupt|프로세스 동기화|세마포어/뮤텍스|멀티스레드/데드락|
